#ifndef ALGORITHM_SEARCHING_SEQUENTIAL_SEARCH_SYMBOL_TABLE_H
#define ALGORITHM_SEARCHING_SEQUENTIAL_SEARCH_SYMBOL_TABLE_H
...
#endif //ALGORITHM_SEARCHING_SEQUENTIAL_SEARCH_SYMBOL_TABLE_H
